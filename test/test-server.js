...
const data = require('../services/timeChartData.js')();
const server = require('../serverHelpers/helpers.js');


describe('serverHelper', function() {
  // check function exists
  it('should have a function called "filterByDate"', () => {
    expect(typeof server.filterByDate).to.equal('function');
  });
